"""
Tests for cryoblob.types module

This module tests type aliases and the MRC_Image PyTree structure.
"""
...
class TestMRCImage(chex.TestCase):
    """Test MRC_Image PyTree structure."""
    ...
    def test_make_mrc_image_2d(self):
        """Test creating MRC_Image with 2D data."""
        def create_mrc():
    ...
    def test_make_mrc_image_3d(self):
        """Test creating MRC_Image with 3D data."""
        def create_mrc():
    ...
    def test_mrc_image_is_pytree(self):
        """Test that MRC_Image is a valid JAX PyTree."""
    ...
    def test_mrc_image_processing(self):
        """Test that MRC_Image works with JAX transformations."""
        mrc_image = make_MRC_Image(**self.sample_2d_data)
    ...
    def test_mrc_image_vmap_compatible(self):
        """Test that MRC_Image works with vmap."""
    ...
    def test_mrc_image_tree_map(self):
        """Test that tree_map works correctly with MRC_Image."""
        mrc_image = make_MRC_Image(**self.sample_2d_data)
        def scale_by_two(x):
    ...
    def test_mrc_image_immutability(self):
        """Test that MRC_Image behaves as immutable (NamedTuple property)."""
        mrc_image = make_MRC_Image(**self.sample_2d_data)
    ...
    def test_mrc_image_with_different_dtypes(self, dtype):
        """Test MRC_Image with various data types."""
    ...
    def test_mrc_image_various_shapes(self, shape):
        """Test MRC_Image with various image shapes."""
        mrc_image = make_MRC_Image(
...
class TestTypeValidation(chex.TestCase):
    """Test type validation with beartype."""
    
    def test_make_mrc_image_type_validation(self):
        """Test that make_MRC_Image validates input types."""
        make_MRC_Image(
