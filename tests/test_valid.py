...
class TestPreprocessingConfig:
    ...
    def test_conflicting_transformations(self):
        with pytest.raises(ValidationError, match="Cannot apply both exponential and logarithmic"):
...
class TestBlobDetectionConfig:
    ...
    def test_invalid_blob_size_range(self):
        with pytest.raises(ValidationError, match="max_blob_size.*must be.*min_blob_size"):
...
class TestValidationPipeline:
    ...
    def test_batch_processing_validation_without_file_config(self):
        ...
        with pytest.raises(ValueError, match="file_processing configuration is required"):
    ...
    def test_batch_processing_validation_with_file_config(self):
        with TemporaryDirectory() as temp_dir:
            ...
            prep_config, blob_config, file_config = pipeline.validate_for_batch_processing()
