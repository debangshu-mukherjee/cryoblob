...
class TestBlobList:
    ...
    def test_valid_input_image(self):
        ...
        image: Float[cp.ndarray, "3 3"] = cp.array(
            [[1, 1, 1], [1, 1, 1], [1, 1, 1]], dtype=cp.float64
        )
    ...
    def test_single_pixel_input_image(self):
        ...
        image = cp.array([[1]], dtype=cp.float64)
    ...
    def test_invalid_input_image(self):
        ...
        image = cp.array([[1, 1, 1], [1, 1, 1]], dtype=cp.float64)
    ...
    def test_non_numeric_input_image(self):
        ...
        image = cp.array(
            [["a", "b", "c"], ["d", "e", "f"], ["g", "h", "i"]], dtype=cp.float64
        )
    ...
    def test_handle_nan_inf_values(self):
        ...
        image = cp.array([[1, 2, cp.nan], [3, cp.inf, 4], [5, 6, 7]], dtype=cp.float64)
    ...
    def test_valid_input_image(self):
        # Initialize input image
        image = cp.array([[1, 1, 1], [1, 1, 1], [1, 1, 1]], dtype=cp.float64)
    ...
    def test_handle_zero_input(self):
        # Initialize input image
        image = cp.zeros((3, 3), dtype=cp.float64)
    ...
    def test_handle_all_ones_input(self):
        # Initialize input image
        image = cp.ones((3, 3), dtype=cp.float64)
